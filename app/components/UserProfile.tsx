...
export function ProfileModal({
  ...
  const displayName =
    nickname ?? (openid ? `用户_${openid.slice(-4)}` : "未知用户");
  ...
  const atsPctFree =
    atsUsedFree !== null && atsLimitFree
      ? Math.min(1, atsUsedFree / atsLimitFree)
      : 1;
            ...
            {activeTab === "orders" ? (
                    ...
                    {orders.map((o) => (
                      ...
                      >
                        <div>
                          ...
                          >
                            {new Date(o.paidAt).toLocaleDateString("zh-CN", {
                              year: "numeric",
                              month: "short",
                              day: "numeric",
                            })}
              ...
              <>
                ...
                {[
                  ...
                  {
                    label: "生成英文简历",
                    used: displayTranslateUsed,
                    limit: PRO_TRANSLATE_LIMIT,
                  },
                  {
                    label: "简历智能导入",
                    used: displayImportUsed,
                    limit: PRO_IMPORT_LIMIT,
                  },
                          ...
                          style={{
                            ...
                            background:
                              pct >= 1
                                ...
                                : "linear-gradient(90deg, #ff9240, #ff6700)",
                            borderRadius: "9999px",
                            transition:
...
interface UserDropdownProps {
  ...
  membership:
    | { plan: string; purchased_at: number; expires_at?: number }
    | null
    | undefined;
...
export function UserDropdown({
  ...
  const displayName =
    nickname ?? (openid ? `用户_${(openid as string).slice(-4)}` : "我");
  const isPro = isActiveSub(membership?.plan, membership?.expires_at);
            ...
            <>
              <span
                style={{
                  fontSize: "13px",
                  fontWeight: 500,
                  color: dark ? "rgba(255,255,255,0.85)" : "var(--ink2)",
                  maxWidth: "80px",
                  overflow: "hidden",
              ...
              <svg
                ...
                fill="none"
                style={{
                  color: dark ? "rgba(255,255,255,0.45)" : "var(--ink3)",
                  flexShrink: 0,
                  transition: "transform 0.2s",
        ...
        {open && (
          <div
            style={{
              ...
              borderRadius: "12px",
              boxShadow:
                "0 8px 30px rgba(0,0,0,0.13), 0 1px 4px rgba(0,0,0,0.06)",
          ...
          >
            ...
            >
              <svg
                ...
                viewBox="0 0 15 15"
                fill="none"
                style={{ flexShrink: 0, color: "var(--theme-blue)" }}
              >
                <circle
                  cx="7.5"
                  cy="5"
            ...
            >
              ...
              >
                <path
                  d="M9.5 10.5v1.75A1.25 1.25 0 0 1 8.25 13.5h-5.5A1.25 1.25 0 0 1 1.5 12.25v-9.5A1.25 1.25 0 0 1 2.75 1.5h5.5A1.25 1.25 0 0 1 9.5 2.75V4.5"
                  stroke="currentColor"
                  strokeWidth="1.4"
                  strokeLinecap="round"
                />
                <path
                  d="M12.5 7.5H5.5m7 0-2-2m2 2-2 2"
                  stroke="currentColor"
                  strokeWidth="1.4"
                  strokeLinecap="round"
                  strokeLinejoin="round"
