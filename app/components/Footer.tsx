...
function AboutContent() {
  return (
    <div>
      ...
      <ul style={uls}>
        <li style={lis}>50+ 套专业简历模板，覆盖互联网、金融、设计、学术等主流行业</li>
        <li style={lis}>AI 内容优化：一键重写工作/项目描述，让描述更量化、更有说服力</li>
        <li style={lis}>岗位匹配分析：上传 JD，AI 分析匹配度并给出针对性修改建议</li>
...
const FAQ_SECTIONS = [
  {
    cat: '基础使用',
    items: [
      { q: '简力全开是免费使用的吗？', a: '是的，基础功能完全免费：5 套基础模板、在线编辑、PDF 下载（含水印）、模块拖拽排序、保存无限份简历。去除水印、全部 50+ 模板、AI 优化等高级功能需升级 Pro 或单次购买。' },
