                  ...
                  <>
                    <button
                      ...
                      style={{
                        ...
                        background: "#f8fafc",
                        border: "1px solid #e2e8f0",
                        borderRadius: showInterviewQ ? "6px 6px 0 0" : "6px",
                        cursor: "pointer",
                        transition: "all 0.2s",
                        fontFamily: "var(--font-sans)",
                      }}
...
export function StudentModal({
  ...
  return (
    <ModalWrap onClose={onClose}>
      ...
      <div style={{ padding: "12px", background: "#f0fdf4", borderRadius: "6px", border: "1px solid #bbf7d0", fontSize: "12px", color: "#15803d", lineHeight: 1.8 }}>
...
export function NewResumeWizardModal({
  ...
  return (
    ...
    >
      <div style={{ background: 'white', borderRadius: '10px', padding: '32px 28px 28px', width: '480px', maxWidth: '100%', boxShadow: '0 20px 60px rgba(15,23,42,0.25)', animation: 'fadeUp 0.2s ease' }}>
        <style>{`@keyframes fadeUp{from{opacity:0;transform:scale(0.95) translateY(8px)}to{opacity:1;transform:scale(1) translateY(0)}}`}</style>
